...
router.post("/nuevocliente", async(req,res)=>{
    ...
    const{sucursal,codven,fecha,nitclie,tiponegocio,negocio,nomclie,dirclie,codmun,coddepto,referencia,obs,telefono,visita,lat,long,sector,
            codgira,tipocliente,especialidad,colegiado,categoria,encargado} = req.body;
    ...
    INSERT INTO CLIENTES (
                    ...
                    CRM_ESPECIALIDAD,CRM_CATEGORIA,CRM_COLEGIADO,CRM_ENCARGADO) 
        SELECT 
            '${sucursal}' AS EMPNIT,'SN' AS DPI,'${nitclie}' AS NIT, '${nomclie}' AS NOMBRECLIENTE,
                ...
                '${especialidad}' AS CRM_ESPECIALIDAD, '${categoria}' AS CRM_CATEGORIA, '${colegiado}' AS CRM_COLEGIADO,
                '${encargado}' AS CRM_ENCARGADO 
